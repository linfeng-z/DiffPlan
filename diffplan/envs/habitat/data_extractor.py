...
class ImageExtractor:
    ...
    def _get_pathfinder_reference_point(self, pf):
        ...
        starty = pf.get_random_navigable_point()[1]
    ...
    def _config_sim(self, scene_filepath, img_size):
        settings = {
            ...
            "silent": True,
            # TODO removed absolute path
            # "scene_dataset":"./dataset/habitat/data/scene_datasets/mp3d_example/mp3d.scene_dataset_config.json"
            "scene_dataset": "./dataset/habitat/gibson_semantic.scene_dataset_config.json",
        }
